...
properties([
    buildDiscarder(logRotator(daysToKeepStr: '60', numToKeepStr: '6')),
...
def rc = 0
def docker_tag="arm64v8/ubuntu:17.10"
def chroot = "chroot-arm64v8-ubuntu-17.10"
...
create_chroot () {
    ...
    sudo rm -rf ${chroot}
    riid=$(sudo --preserve-env rkt --insecure-options=image fetch "docker://${docker_tag}")
